...
const Section2 = () => {
  return (
    <section className=" min-h-screen min-w-[100vw] pb-8 mb-60 ">
            ...
            <div className="grid h-[115vh] grid-cols-2  grid-rows-3   gap-7">
                <BentoTilt className="bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2 rounded-xl">
                    <BentoCard
                        ...
                        title={<>Zig<b>m</b>a</>}
                        description={"An anime and gaming-inspired NFT collection - the IP primed foe expansion."}
                    />
                </BentoTilt>
                <BentoTilt className="bento-tilt_1 row-span-1 ms-32 md:col-span-1  md:ms-0 rounded-xl">
                    <BentoCard
                        ...
                        title={<>N<b>e</b>xus</>}
                        description={"A gamified social hub, adding a new dimensions of play to social interaction for Web3 communities."}
                    />
                </BentoTilt>
                ...
                <BentoTilt className="bento-tilt_2">
                    <div className="flex size-full flex-col justify-between bg-west-300 p-5">
                        <h1 className="bento-title special-font max-w-64 lg:!text-7xl !text-6xl  text-black">Mo<b>r</b>e co<b>m</b>ing s<b>oo</b>n!</h1>
