    ...
    <div className="mb-32">
      <div className="grid gap-6 p-4 max-w-6xl h-screen mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-[70vh]">
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/10 p-6 rounded-lg flex items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-white/10 backdrop-blur-md border border-white/10 p-6 rounded-lg h-auto">
